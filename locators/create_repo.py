...
class CreateRepoLocators(LoggedInHeaderLocators, FooterLocators, BasePageLocators):
    ...
    issue_labels_dropdown_menu = By.XPATH, '//div[@class="inline field"]/label[contains(text(), "Метки задач")]/following-sibling::div'
    gitignore_template_dropdown_menu = By.XPATH, '//div[@class="inline field"]/label[contains(text(), ".gitignore")]/following-sibling::div'
    license_template_dropdown_menu = By.XPATH, '//div[@class="inline field"]/label[contains(text(), "Лицензия")]/following-sibling::div'
    license_choose_link = By.CSS_SELECTOR, 'a[href*="https://choosealicense.com"]'
    readme_template_dropdown_menu = By.XPATH, '//div[@class="inline field"]/label[contains(text(), "README")]/following-sibling::div'
    init_repo_checkbox = By.CSS_SELECTOR, 'div#auto-init > label'
    default_branch_input = By.ID, 'default_branch'
    subscription_trust_model_dropdown_menu = By.XPATH, '//div[@class="inline field"]/label[contains(text(), "Модель доверия подписи")]/following-sibling::div[contains(@class, "dropdown")]'
