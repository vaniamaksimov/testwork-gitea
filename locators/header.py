...
class LoggedInHeaderLocators(BaseHeader):
    ...
    new_org_dropdown_link = (
        By.CSS_SELECTOR,
        'div.menu.left a.item[role="menuitem"][href*="/org/create"]',
    )

    profile_dropdown_menu = (
        By.CSS_SELECTOR,
        '.ui.dropdown[data-tooltip-content="Профиль и настройки..."]',
    )
    ...
    notifications_dropdown_link = (
        By.CSS_SELECTOR,
        'a.item[role="menuitem"][href*="/notifications/subscriptions"]',
    )
